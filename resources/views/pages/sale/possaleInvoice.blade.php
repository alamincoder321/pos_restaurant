...
@section('title', 'POS Order Invoice')
@section('breadcrumb', 'POS Order Invoice')
@push('style')
<style>
    tr td,
    tr th {
...
<div id="saleInvoice">
    <div class="col-md-10 offset-md-1">
        <pos-invoice-preview
            ...
            :sale="sale"
            :username="username"
            @close="printInvoice = false"></pos-invoice-preview>
    </div>
</div>
@endsection

@push('js')
<script src="{{asset('component')}}/PosSaleInvoicePreview.js"></script>
<script>
    new Vue({
        el: '#saleInvoice',
        data: {
